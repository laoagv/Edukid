...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        # fields = ([])
        fields = ('type_of_user', 'name', 'surname','father_name', 'email')
        widgets = {
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('name', 'surname','father_name','type_of_user', 'phone', 'picture', 'date_of_birth', 'gender', 'school')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'name', 'surname','father_name','type_of_user', 'password1', 'password2'),
        }),
    )
    search_fields = ('email',)
    ordering = ('email',)
